...
const FALLBACK = {
  '93401': [
    { id: 'dl-0', address: '410 Higuera St — Room', city: 'San Luis Obispo', zip: '93401', price: 950,  beds: 1, baths: 1, sqft: 220, lat: 35.2812, lng: -120.6625, type: 'Room',     available: 'Now',   features: ['Shared kitchen', 'Utilities included'], petFriendly: false, image: null },
    ...
    { id: 'dl-5', address: '855 Monterey St', city: 'San Luis Obispo', zip: '93401', price: 4200, beds: 3, baths: 2, sqft: 1750, lat: 35.2815, lng: -120.6595, type: 'Townhouse', available: 'Aug 1', features: ['Rooftop deck', '2-car garage', 'AC', 'In-unit laundry'], petFriendly: true, image: null },
    { id: 'dl-6', address: '1900 Johnson Ave',city: 'San Luis Obispo', zip: '93401', price: 5800, beds: 4, baths: 3, sqft: 2400, lat: 35.2700, lng: -120.6500, type: 'House',     available: 'Sep 1', features: ['Hillside views', 'Pool', 'Solar', '3-car garage'], petFriendly: true, image: null },
  ],
  '93405': [
    { id: 'cp-0', address: '320 Hathway Ave — Shared',  city: 'San Luis Obispo', zip: '93405', price: 850,  beds: 1, baths: 1, sqft: 180, lat: 35.3000, lng: -120.6660, type: 'Room',      available: 'Now',    features: ['Student-friendly', 'Utilities included'], petFriendly: false, image: null },
    ...
    { id: 'cp-4', address: '1290 Foothill Blvd',        city: 'San Luis Obispo', zip: '93405', price: 3600, beds: 3, baths: 2, sqft: 1450,lat: 35.3010, lng: -120.6680, type: 'House',     available: 'Aug 1',  features: ['Yard', 'Garage', 'AC', 'Near campus'],     petFriendly: true,  image: null },
    { id: 'cp-5', address: '2455 Loomis St',            city: 'San Luis Obispo', zip: '93405', price: 5200, beds: 4, baths: 3, sqft: 2100,lat: 35.3050, lng: -120.6720, type: 'House',     available: 'Sep 1',  features: ['Pool', 'Solar', 'Smart home', '2-car garage'], petFriendly: true, image: null },
  ],
  '93424': [
