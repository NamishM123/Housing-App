...
export default function NeighborhoodPanel({ open, activeTab, neighborhood, form, onClose, listings, listingsLoading, searchUrls, shortlist, onShortlist }) {
  ...
  useEffect(() => { setChecklist(null); setFurniture(null); }, [neighborhood?.id]);
      ...
      <div className="n-panel-body">
        ...
        {activeTab === 'insights' && (
          <div className="insights-tab">
            <InsightRow icon="🔊" label="Noise Level" value={neighborhood.noiseLevel}       badge={neighborhood.noiseLevel}       detail={neighborhood.noiseSources} />
